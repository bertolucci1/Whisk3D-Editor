...
void Outliner::Render(){
    ...
    w3dEngine::Color4f(ListaColores[static_cast<int>(ColorID::grisUI)][0], ListaColores[static_cast<int>(ColorID::grisUI)][1], ListaColores[static_cast<int>(ColorID::grisUI)][2], ListaColores[static_cast<int>(ColorID::grisUI)][3]);
    RenglonesY = 0;
...
void Outliner::DibujarRenglon(Object* obj, bool hidden){
    ...
    if (moviendo && obj == moverObj){
        ...
        w3dEngine::Color4f(ListaColores[static_cast<int>(ColorID::accentDark)][0], ListaColores[static_cast<int>(ColorID::accentDark)][1],
